		...
		do
			...
			do
				...
				do
					...
					TARGET=verify_daily/${INTERVALO}/out/${RESOLUTION}/${VARIABLE}/${MES}/R_scriptLines_0p${RESOLUTION}_${VARIABLE}_${MES}_${DAY}_${STATION}.Rout
					if grep -Fq "MAE               =" $TARGET
					then
						grep -F "MAE               =" $TARGET > MAE_${RESOLUTION}_${MES}_${DAY}_${VARIABLE}.out
						awk -F' ' -v OFS=',' -v DAY=$DAY '$3==($3+0) {print $3,DAY}' MAE_${RESOLUTION}_${MES}_${DAY}_${VARIABLE}.out >> verify_daily/${INTERVALO}/out/MAE_${RESOLUTION}_${MES}_${VARIABLE}_${STATION}.csv
					else
						echo "NaN,$DAY" >> verify_daily/${INTERVALO}/out/MAE_${RESOLUTION}_${MES}_${VARIABLE}_${STATION}.csv
					fi

					if grep -Fq "ME                =" $TARGET
					then
						grep -F "ME                =" $TARGET > ME_${RESOLUTION}_${MES}_${DAY}_${VARIABLE}.out
						awk -F' ' -v OFS=',' -v DAY=$DAY '$3==($3+0) {print $3,DAY}' ME_${RESOLUTION}_${MES}_${DAY}_${VARIABLE}.out >> verify_daily/${INTERVALO}/out/ME_${RESOLUTION}_${MES}_${VARIABLE}_${STATION}.csv
					else
						echo "NaN,$DAY" >> verify_daily/${INTERVALO}/out/ME_${RESOLUTION}_${MES}_${VARIABLE}_${STATION}.csv
					fi
	
					if grep -Fq "MSE               =" $TARGET
					then
						grep -F "MSE               =" $TARGET > MSE_${RESOLUTION}_${MES}_${DAY}_${VARIABLE}.out
						awk -F' ' -v OFS=',' -v DAY=$DAY '$3==($3+0) {print $3,DAY}' MSE_${RESOLUTION}_${MES}_${DAY}_${VARIABLE}.out >> verify_daily/${INTERVALO}/out/MSE_${RESOLUTION}_${MES}_${VARIABLE}_${STATION}.csv
					else
						echo "NaN,$DAY" >> verify_daily/${INTERVALO}/out/MSE_${RESOLUTION}_${MES}_${VARIABLE}_${STATION}.csv
					fi
				done
			done
		done

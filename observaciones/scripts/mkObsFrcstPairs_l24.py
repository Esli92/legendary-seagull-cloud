...
wrf_day_sim = wrf_list[24:dfh+25]
...
file_str = "../../../../../observaciones/dataFiles/pares/l24h/ObsFct_Pairs_{}_{}_{}_{}_15.txt".format(var_name,wrf_station_name,wrf_day+10,wrf_month)

#DEBUG_LINE:
#file_str = "../dataFiles/pares/l24h/ObsFct_Pairs_{}_{}_{}_{}_15.txt".format(var_name,wrf_station_name,wrf_day,wrf_month)

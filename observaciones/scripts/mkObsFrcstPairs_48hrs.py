...
#Para las 48 horas tomaremos tambien el dia siguiente
did = 0
...
#ESTA es la linea magica el empalme de 48 horas. ----------------------------------------------------------
obs_day = obs_day[0:dfd+25]
...
file_str = "../../../../../observaciones/dataFiles/pares/48h/ObsFct_Pairs_{}_{}_{}_{}_15.txt".format(var_name,wrf_station_name,wrf_day+10,wrf_month)

#DEBUG_LINE:
#file_str = "../dataFiles/pares/48h/ObsFct_Pairs_{}_{}_{}_{}_15.txt".format(var_name,wrf_station_name,wrf_day,wrf_month)

...
estaciones = ['altzom';'cdalta';'ecogua';'elchic';'encb02';'huaman';'huauch';'huicha';'huimil';'iguala';'imteag';'izucar';'lagzem';'lama01';'lama02';'mona01';'mona02';'pqizta';'shuaut';'tecama';'tepozt';'tezont';'tresma';'vabrav'];
...
directorio_trabajo = '/home/alumno/Documentos/WRF/experimentos/verificacion/observaciones/limpiezaMatlab/EMAS_centro_mexico';
...
for i=1:i_estacion
    ...
    for j=1:12
        ...
        %Temperatura
        nombre_archivo = [mes_num(j,:) '_' estaciones(i,:) '_' meses(j,:) '_15'  '_temp.txt'];
        if exist(nombre_archivo,'file')
            ...
            %Viento
            nombre_archivo = [mes_num(j,:) '_' estaciones(i,:) '_' meses(j,:) '_15' '_windSpd.txt'];
            bandera_no_data = 0;
            ...
            nombre = [localizacion '_' mes_num(j,:) '_' meses(j,:) '_' estaciones(i,:)];

'open ../input/02_0p25/wrfout_GRADS_19-20_02_2017_d02.ctl'
...
'printim ../graficos/19-20/viento/viento_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/19-20/temp/temperatura_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/19-20/presion/presion_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/19-20/radiacion/radiacion_'contador'_dia'day'_'hora'Z.png png white'
*para el albedo
'c'
'd albedo'
'cbarn'
...
'printim ../graficos/19-20/albedo/albedo_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/19-20/PBLH/PBLH_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/19-20/PP/PP_'contador'_dia'day'_'hora'Z.png png white'
*para geopotencial
'c'
'set lev 500'
'd geopt'
...
'printim ../graficos/19-20/geopotencial/geop_'contador'_dia'day'_'hora'Z.png png white'
'c'

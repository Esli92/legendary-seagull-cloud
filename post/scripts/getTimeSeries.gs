...
write('XAL_20_09_15_TM.txt', 'HOUR,   LON,    LAT,    WSFRCST')
write('XAL_20_09_15_WS.txt', 'HOUR,   LON,    LAT,    WSFRCST')
*write('XAL_20_09_15_RN.txt', 'HOUR,   LON,    LAT,    WSFRCST')
...
*    write('XAL_20_09_15_RN.txt', t-1',    'lon',    'lat',    'tmp,append)
...
*    Note the "append", so to add to the file instead of overwriting it
     ...
     write('XAL_20_09_15_TM.txt', (t-1)*3',    'lon',    'lat',    'tmp,append)
...
*    Note the "append", so to add to the file instead of overwriting it
     ...
     write('XAL_20_09_15_WS.txt', (t-1)*3',    'lon',    'lat',    'tmp,append)

'open ../input/abr_0p50/wrfout_GRADS_04-06_04_2015_d02.ctl'
...
'printim ../graficos/04-06/viento/viento_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/04-06/temp/temperatura_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/04-06/presion/presion_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/04-06/radiacion/radiacion_'contador'_dia'day'_'hora'Z.png png white'
*para el albedo
'c'
'd albedo'
'cbarn'
...
'printim ../graficos/04-06/albedo/albedo_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/04-06/PBLH/PBLH_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/04-06/PP/PP_'contador'_dia'day'_'hora'Z.png png white'
*para geopotencial
'c'
'set lev 500'
'd geopt'
...
'printim ../graficos/04-06/geopotencial/geop_'contador'_dia'day'_'hora'Z.png png white'
'c'

'open ../input/abr_0p50/wrfout_GRADS_03-05_04_2015_d02.ctl'
...
'printim ../graficos/03-05/viento/viento_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/03-05/temp/temperatura_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/03-05/presion/presion_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/03-05/radiacion/radiacion_'contador'_dia'day'_'hora'Z.png png white'
*para el albedo
'c'
'd albedo'
'cbarn'
...
'printim ../graficos/03-05/albedo/albedo_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/03-05/PBLH/PBLH_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/03-05/PP/PP_'contador'_dia'day'_'hora'Z.png png white'
*para geopotencial
'c'
'set lev 500'
'd geopt'
...
'printim ../graficos/03-05/geopotencial/geop_'contador'_dia'day'_'hora'Z.png png white'
'c'

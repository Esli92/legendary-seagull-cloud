'open ../input/abr_0p50/wrfout_GRADS_06-08_04_2015_d02.ctl'
...
'printim ../graficos/06-08/viento/viento_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/06-08/temp/temperatura_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/06-08/presion/presion_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/06-08/radiacion/radiacion_'contador'_dia'day'_'hora'Z.png png white'
*para el albedo
'c'
'd albedo'
'cbarn'
...
'printim ../graficos/06-08/albedo/albedo_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/06-08/PBLH/PBLH_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/06-08/PP/PP_'contador'_dia'day'_'hora'Z.png png white'
*para geopotencial
'c'
'set lev 500'
'd geopt'
...
'printim ../graficos/06-08/geopotencial/geop_'contador'_dia'day'_'hora'Z.png png white'
'c'

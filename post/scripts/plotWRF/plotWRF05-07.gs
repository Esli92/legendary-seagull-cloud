'open ../input/abr_0p50/wrfout_GRADS_05-07_04_2015_d02.ctl'
...
'printim ../graficos/05-07/viento/viento_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/05-07/temp/temperatura_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/05-07/presion/presion_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/05-07/radiacion/radiacion_'contador'_dia'day'_'hora'Z.png png white'
*para el albedo
'c'
'd albedo'
'cbarn'
...
'printim ../graficos/05-07/albedo/albedo_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/05-07/PBLH/PBLH_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/05-07/PP/PP_'contador'_dia'day'_'hora'Z.png png white'
*para geopotencial
'c'
'set lev 500'
'd geopt'
...
'printim ../graficos/05-07/geopotencial/geop_'contador'_dia'day'_'hora'Z.png png white'
'c'

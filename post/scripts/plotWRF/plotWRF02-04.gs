'open ../input/abr_0p50/wrfout_GRADS_02-04_04_2015_d02.ctl'
...
'printim ../graficos/02-04/viento/viento_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/02-04/temp/temperatura_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/02-04/presion/presion_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/02-04/radiacion/radiacion_'contador'_dia'day'_'hora'Z.png png white'
*para el albedo
'c'
'd albedo'
'cbarn'
...
'printim ../graficos/02-04/albedo/albedo_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/02-04/PBLH/PBLH_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/02-04/PP/PP_'contador'_dia'day'_'hora'Z.png png white'
*para geopotencial
'c'
'set lev 500'
'd geopt'
...
'printim ../graficos/02-04/geopotencial/geop_'contador'_dia'day'_'hora'Z.png png white'
'c'

'open ../input/abr_0p50/wrfout_GRADS_07-09_04_2015_d02.ctl'
...
'printim ../graficos/07-09/viento/viento_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/07-09/temp/temperatura_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/07-09/presion/presion_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/07-09/radiacion/radiacion_'contador'_dia'day'_'hora'Z.png png white'
*para el albedo
'c'
'd albedo'
'cbarn'
...
'printim ../graficos/07-09/albedo/albedo_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/07-09/PBLH/PBLH_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/07-09/PP/PP_'contador'_dia'day'_'hora'Z.png png white'
*para geopotencial
'c'
'set lev 500'
'd geopt'
...
'printim ../graficos/07-09/geopotencial/geop_'contador'_dia'day'_'hora'Z.png png white'
'c'

'open ../input/05_0p25/wrfout_GRADS_01-03_05_2015_d02.ctl'
...
'printim ../graficos/01-03/viento/viento_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/01-03/temp/temperatura_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/01-03/presion/presion_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/01-03/radiacion/radiacion_'contador'_dia'day'_'hora'Z.png png white'
*para el albedo
'c'
'd albedo'
'cbarn'
...
'printim ../graficos/01-03/albedo/albedo_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/01-03/PBLH/PBLH_'contador'_dia'day'_'hora'Z.png png white'
...
'printim ../graficos/01-03/PP/PP_'contador'_dia'day'_'hora'Z.png png white'
*para geopotencial
'c'
'set lev 500'
'd geopt'
...
'printim ../graficos/01-03/geopotencial/geop_'contador'_dia'day'_'hora'Z.png png white'
'c'
